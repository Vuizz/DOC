...
function expandA(){
    if (a == 1){
        ...
        document.getElementById("Faq1").style.backgroundColor = 'transparent'
...
function expandB(){
    if (b == 1){
        ...
        document.getElementById("Faq2").style.backgroundColor = 'transparent'
...
function expandC(){
    if (c == 1){
        ...
        document.getElementById("Faq3").style.backgroundColor = 'transparent'
...
function expandD(){
    if (d == 1){
        ...
        document.getElementById("Faq4").style.backgroundColor = 'transparent'
